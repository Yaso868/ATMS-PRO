...
function showView(v){
  ['listView','cockpitView','importView','settingsView','liveDispositionView'].forEach(id=>{const el=$(id);if(el)el.classList.add('hidden')});
...
function liveDispositionAssessment(r,threshold=7){
  ...
  return{hasLive:false,hasDelayAssessment:false,delay:null,label:'Keine Live-Daten',className:''};
}
